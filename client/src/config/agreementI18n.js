...
const DICT = {
  en: {
    ...
    email: 'Email',
    notes: 'Notes',
    stmtAuthorize: 'I hereby authorize and request the delivery of the item/s, document/s, or package/s to',
    stmtCoordPre: 'For coordination and verification purposes,',
    stmtCoordPost: 'may be contacted through the following details:',
    stmtContact: 'Contact Number:',
    stmtEmail: 'Email Address:',
    stmtIssued: 'This statement is issued to confirm the authorized delivery recipient and delivery location.',
  ...
  tl: {
    docTitle: 'Kumpirmasyon ng Order',
    ...
    email: 'Email',
    notes: 'Mga tala',
    stmtAuthorize: 'Pinahihintulutan at hinihiling ko ang paghahatid ng item/s, dokumento/s, o package/s kay',
    stmtCoordPre: 'Para sa koordinasyon at beripikasyon, si',
    stmtCoordPost: 'ay maaaring makontak sa pamamagitan ng mga sumusunod na detalye:',
    stmtContact: 'Numero ng Kontak:',
    stmtEmail: 'Email Address:',
    stmtIssued: 'Ang pahayag na ito ay inisyu upang kumpirmahin ang awtorisadong tatanggap at lokasyon ng paghahatid.',
